...
const cookieImg = document.querySelector("#cookieClosed")
...
document.addEventListener('click', handleClickEnter);
...
function changeLuck() {
  ...
  screen2.querySelector('.screen2 p').innerText = phrases[randomNumber];
}
